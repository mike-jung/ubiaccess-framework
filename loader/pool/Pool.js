...
Pool.prototype.getConnection = function (cb, receiver) {
  ...
  if (this._freeConnections.length > 0) {
    ...
    this.acquireConnection(connection, cb, receiver);
...
Pool.prototype.acquireConnection = function acquireConnection(connection, cb, receiver) {
  ...
  function onOperationComplete(err) {
    ...
    // set listeners after removing previous listeners
    ...
    connection._socket.removeAllListeners('end'); 
    connection._socket.on('end', function() {
